  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div className="w-full max-w-md rounded-t-3xl bg-card flex flex-col" style={{ maxHeight: "78vh" }}>
            {/* Header */}
            ...
            <div className="flex items-center gap-3 px-5 pb-3 flex-shrink-0">
              <div className="relative h-14 w-14 rounded-full overflow-hidden ring-2 ring-primary/50 flex-shrink-0">
                {selectedImage ? (
                  ...
                  <div className={`flex h-full w-full items-center justify-center bg-gradient-to-br ${gradient} text-2xl`}>
              ...
              <div className="flex-1">
                <input
                  ...
                  maxLength={24}
                  className="rounded-xl glass px-3 py-2 text-sm font-bold text-foreground outline-none w-full"
                  placeholder="Display name"
                />
                {(selectedImage || avatarUrl) && (
                  <button
                    onClick={() => setSelectedImage(null)}
                    className="text-[11px] text-muted-foreground hover:text-neon-pink transition-colors mt-1"
                  >
                    Use emoji fallback
                  </button>
                )}
            ...
            <div className="px-5 pt-3 pb-5 flex-shrink-0 border-t border-border/30 bg-card">
              <button
                onClick={handleSave}
                className="w-full rounded-2xl bg-gradient-to-r from-primary to-secondary py-3.5 text-sm font-extrabold uppercase tracking-widest text-primary-foreground shadow-lg"
              >
                ✓ Save Avatar
              </button>
            </div>
